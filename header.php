    ...
    <secsion class="top">
        <div class="container">
            <div class="row">
                ...
                <div class="top-logo">
                    <a href="index.php"><img style="width: 100px; height: 60px;" src="image/game-control-with-no-battery.png" alt=""></a>
                </div>
                        ...
                        <li>
                            ...
                            <div class="cart-content-mini">
                                ...
                                <div class="cart-content-mini-item">
                                    ...
                                    <p>Màu: Trắng</p>
                                    <p>Opntion: <?php echo $result['sanpham_size']  ?></p>
