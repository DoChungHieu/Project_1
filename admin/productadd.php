 ...
 <div class="admin-content-right">
            <div class="product-add-content">
                ...
                <form action="productadd.php" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="">Chọn option sản phẩm<span style="color: red;">*</span></label> <br>
                    <div class="sanpham-size">
                    <p>CH</p>    <input type="checkbox" name="sanpham-size[]" value="CH"> 
                    <p>2hand</p>    <input type="checkbox" name="sanpham-size[]" value="2hand"> 
                    <p>SPF</p>    <input type="checkbox" name="sanpham-size[]" value="SPF">
